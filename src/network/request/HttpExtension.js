...
import {API_URL, XIAMIMUSIC, XIAMI_URL} from '../config/hostConfig'
import {ApiSource} from '../config/commonType'
...
const fetchData = (isCache, requestType) => (url, params, isLoading, source, callback) => {
  ...
  return dataCache(params.method, fetchFunc, isCache)
}
 ...
 * @returns {{promise: Promise}}
 */
const postFetchFromCache = fetchData(true, 'POST')
...
export {getFetch, postFetch, putFetch, deleteFetch, getFetchFromCache , postFetchFromCache , postFetchForValidator}